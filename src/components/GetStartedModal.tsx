...
export default function GetStartedModal({ isOpen, onClose }: GetStartedModalProps) {
  ...
  const audCopy = {
    en: {
      ...
      successMsg: "Thank you, {name}. Our Qatari real estate automation specialists at Ansury Systems have reserved your 30-minute consultation slot.",
    ...
    ar: {
      ...
      successMsg: "شكراً لك، {name}. لقد قام مستشارو أتمتة العقارات في قطر لدى أنظمة أنسوري بحجز مقعدك وجدولة دراسة الكفاءة والجدوى المخصصة لمدة 30 دقيقة.",
